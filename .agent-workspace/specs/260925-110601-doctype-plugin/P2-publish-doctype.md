...
- [ ] In the README entries disclose that tractatus pages containing math request MathJax 3.2.2 and fonts from `cdn.jsdelivr.net` when online, with visible TeX source offline. Document example provenance without adding Gutenberg trademark material to the example.
