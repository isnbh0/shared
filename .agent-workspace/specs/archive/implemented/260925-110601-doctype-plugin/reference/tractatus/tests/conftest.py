"""Test harness for the my-tractatus template.

Run from the dotfiles root:
    uv run --with pytest --with pytest-playwright --with hypothesis \
        pytest macbook/claude/skills/my-tractatus/tests -q
...
# storage in the skill directory (gitignored) rather than in the working directory.
set_hypothesis_home_dir(SKILL_DIR / ".hypothesis")
