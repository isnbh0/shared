...
_FLATTEN_MAP: dict[str, str] = {
    ...
    "model.pi_exec_path": "pi_exec_path",
    "model.pi_exec_provider": "pi_exec_provider",
    "model.pi_exec_thinking": "pi_exec_thinking",
    "model.pi_exec_use_sdk": "pi_exec_use_sdk",
    "model.pi_allowed_metered_providers": "pi_allowed_metered_providers",
