...
- **packet** — Packages work as a durable filesystem handoff with flexible structure, pauses only work that depends on the return, then validates returned artifacts by their material contract and resumes
