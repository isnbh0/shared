...
- `macros:packet` — package work as a durable filesystem handoff with flexible structure, pause only work that depends on the return, then validate returned artifacts by their material contract and resume.
